<script lang="ts">
	...
	import HelpDocModal from '$lib/components/common/HelpDocModal.svelte';
	...
	let showHelpDocModal = false; // 帮助文档弹窗显隐状态
...
<HelpDocModal bind:show={showHelpDocModal} docId="project-guide" />
	...
	<div class="app relative">
		...
		>
			...
			{:else}
				...
				<!-- 右侧浮动帮助文档按钮：垂直居中固定定位 -->
				<button
					class="fixed right-3 top-1/2 -translate-y-1/2 z-40
