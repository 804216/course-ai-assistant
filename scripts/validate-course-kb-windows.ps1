...
$validator = Join-Path $projectRoot 'tools\course_kb\validate_course_kb.py'
...
& $venvPython $validator --base-url $BaseUrl
if ($LASTEXITCODE -ne 0) {
    throw "Course knowledge validation failed with exit code $LASTEXITCODE"
}
